...
def thresholding(img):
    ...
    lowerWhite = np.array([86,0,24])
    upperWhite = np.array([138,204,255])
...
def initializeTracbars(initialTrackBarvals, wT=480, hT=240):
...
def getHistogram(img, minPer=0.1,display=False,region=1):
    ...
    if display:
        ...
        for x, intensity in enumerate(histValue):
            ...
            cv2.circle(imgHist,(basePoint,img.shape[0]),20,(255,255,0),cv2.FILLED)
